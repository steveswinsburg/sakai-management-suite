...
/**
 * Main application class for the My Account tool in the users My Workspace AND the New Account tool in the Gateway.
 *  This is a stripped down version of the UserCreateTab in the LMS Management app.
 * 
 * @author Steve Swinsburg (steve.swinsburg@gmail.com)
 *
 */
public class MyAccountApp extends WebApplication {    
	 ...
	 */
	public Class<MyAccountPage> getHomePage() {
